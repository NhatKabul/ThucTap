...
$opt_help          = 0;
$opt_log           = undef();
$opt_mysqladmin    = "C:/Program Files (x86)/MySql/MySQL Server 5.1/bin/mysqladmin";
$opt_mysqld        = "C:/Program Files (x86)/MySql/MySQL Server 5.1/bin/mysqld";
$opt_no_log        = 0;
$opt_password      = undef();
$opt_tcp_ip        = 0;
$opt_user          = "root";
...
#### order:  my_print_defaults mysqld datadir, C:/Program Files (x86)/MySql/MySQL Server 5.1/share
####
...
sub init_log
{
  ...
  if (!defined($logdir))
  {
    $logdir= "C:/Program Files (x86)/MySql/MySQL Server 5.1/share" if (-d "C:/Program Files (x86)/MySql/MySQL Server 5.1/share" && -w "C:/Program Files (x86)/MySql/MySQL Server 5.1/share");
  }
  if (!defined($logdir))
  {
...
sub list_defaults_files
{
  ...
  return grep { defined $_ and not $seen{$_}++ and -f $_ and -r $_ }
              ('/etc/my.cnf',
               '/etc/mysql/my.cnf',
               'C:/Program Files (x86)/MySql/MySQL Server 5.1/my.cnf',
...
#
#   Before using, you must create a my.cnf file either in C:/Program Files (x86)/MySql/MySQL Server 5.1/my.cnf
...
[mysqld_multi]
mysqld     = C:/Program Files (x86)/MySql/MySQL Server 5.1/bin/mysqld_safe
mysqladmin = C:/Program Files (x86)/MySql/MySQL Server 5.1/bin/mysqladmin
user       = multi_admin
...
port       = 3307
pid-file   = C:/Program Files (x86)/MySql/MySQL Server 5.1/data2/hostname.pid2
datadir    = C:/Program Files (x86)/MySql/MySQL Server 5.1/data2
language   = C:/Program Files (x86)/MySql/MySQL Server 5.1/share/mysql/english
user       = unix_user1
...
port       = 3308
pid-file   = C:/Program Files (x86)/MySql/MySQL Server 5.1/data3/hostname.pid3
datadir    = C:/Program Files (x86)/MySql/MySQL Server 5.1/data3
language   = C:/Program Files (x86)/MySql/MySQL Server 5.1/share/mysql/swedish
user       = unix_user2

[mysqld4]
socket     = /tmp/mysql.sock4
port       = 3309
pid-file   = C:/Program Files (x86)/MySql/MySQL Server 5.1/data4/hostname.pid4
datadir    = C:/Program Files (x86)/MySql/MySQL Server 5.1/data4
language   = C:/Program Files (x86)/MySql/MySQL Server 5.1/share/mysql/estonia
user       = unix_user3
 
[mysqld6]
socket     = /tmp/mysql.sock6
port       = 3311
pid-file   = C:/Program Files (x86)/MySql/MySQL Server 5.1/data6/hostname.pid6
datadir    = C:/Program Files (x86)/MySql/MySQL Server 5.1/data6
language   = C:/Program Files (x86)/MySql/MySQL Server 5.1/share/mysql/japanese
user       = unix_user4
EOF
  exit(0);
}
