...
{
  $print_defaults='C:/Program Files (x86)/MySql/MySQL Server 5.1/bin/my_print_defaults';
}
...
{
  $opt->{basedir} = 'C:/Program Files (x86)/MySql/MySQL Server 5.1';
  $bindir         = 'C:/Program Files (x86)/MySql/MySQL Server 5.1/bin';
  $extra_bindir   = $bindir;
  $mysqld         = 'C:/Program Files (x86)/MySql/MySQL Server 5.1/bin/mysqld';
  $pkgdatadir     = 'C:/Program Files (x86)/MySql/MySQL Server 5.1/share';
  $scriptdir      = 'C:/Program Files (x86)/MySql/MySQL Server 5.1/bin';
}

unless ( $opt->{ldata} )
{
  $opt->{ldata} = 'C:/Program Files (x86)/MySql/MySQL Server 5.1/data';
}
  ...
  if ( !$opt->{'cross-bootstrap'} )
  {
    ...
    if ( !$opt->{rpm} )
    {
      report($opt,
             ...
             "",
             "  cd " . 'C:/Program Files (x86)/MySql/MySQL Server 5.1' . " ; $bindir/mysqld_safe &",
             "",
...
else
{
  error($opt,
        ...
        "And if you do mail us, you MUST use the " . 'C:/Program Files (x86)/MySql/MySQL Server 5.1/bin' . "/mysqlbug script!")
}
