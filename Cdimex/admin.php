		    ...
		    <form id="form1" name="form1" method="post" action="">
		        <table align="center" width="1000">
		            <tr>
		              ...
		              <td align="center" width="400"><p><font size="+2"><b>Danh Sách Sản Phẩm</b></font></p></td> 
		              <td align="center" width="300"><p><input type="text" name="txtTim" placeholder="Tên Sản Phẩm, Đơn Giá"><input type="submit" name="btnTim" value="Tìm Kiếm"></p></td>
		            </tr>
		        </table>
		        <table width="1000" border="1" align="center">
		                <tr>
		                  <td align="center" bgcolor="#9ea7b6"><b> ID </b></td>
		                <td align="center" bgcolor="#9ea7b6"><b> Tên Hàng </b></td>
		                <td align="center" bgcolor="#9ea7b6"><b> Đơn Giá </b></td>
		                <td align="center" bgcolor="#9ea7b6"><b> Số Lượng Tồn </b></td>
		                <td align="center" bgcolor="#9ea7b6"><b> Hình Ảnh </b></td>
